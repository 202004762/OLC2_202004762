...
public interface IAnalizadorLexicoListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterLista_argumentos([NotNull] AnalizadorLexicoParser.Lista_argumentosContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="AnalizadorLexicoParser.lista_argumentos"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitLista_argumentos([NotNull] AnalizadorLexicoParser.Lista_argumentosContext context);
	/// <summary>
