...
public interface IAnalizadorLexicoVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="AnalizadorLexicoParser.lista_argumentos"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitLista_argumentos([NotNull] AnalizadorLexicoParser.Lista_argumentosContext context);
	/// <summary>
